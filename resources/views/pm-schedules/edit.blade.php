    ...
    <div class="bg-white rounded-xl shadow p-6 mb-6">
        ...
        <div id="problem-wrapper">
            ...
            <div class="problem-row flex gap-2 mb-2">
                ...
                <select required name="problems[{{ $i }}][problem]" class="problem-select border p-2 w-1/2 rounded">
                ...
                <select required name="problems[{{ $i }}][finding]" class="finding-select border p-2 flex-1 rounded"
    ...
    <div class="mt-6 bg-white p-4 rounded shadow">
        ...
        <div id="sparepart-wrapper">
            ...
            <div class="sparepart-row flex gap-2 mb-2">
                ...
                <select name="spareparts[0][sparepart_id]" class="sparepart-select border p-2 w-2/3 rounded">
                </select>


                <input type="number" name="spareparts[0][qty]" class="border p-2 w-1/3 rounded" placeholder="Qty">
